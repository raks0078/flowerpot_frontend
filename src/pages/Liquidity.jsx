        ...
        <div className="card">
          ...
          <div className="card-body">
            <span className="liquidity">
              Your Liquidity
              <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tooltip on bottom">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
              </a>
            </span>
            <span className="opac-text">Connect to a wallet to view your liquidity.</span>
            <small>Don't see a pool you joined? 
              <a href="javascript:void(0)"> Import it.</a>
            </small>
            <small>Or, if you staked your LP tokens in a farm, unstake them to see them here.</small>
          </div>
        </div>
      </div>
      </>
